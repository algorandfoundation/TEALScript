...
export class AbiTest extends bkr.ApplicationClient {
    ...
    override methods: algosdk.ABIMethod[] = [
        ...
        new algosdk.ABIMethod({ name: "updateDynamicArrayInTuple", desc: "", args: [], returns: { type: "uint16[]", desc: "" } })
    ];
    ...
    async updateDynamicArrayInTuple(txnParams?: bkr.TransactionOverrides): Promise<bkr.ABIResult<bigint[]>> {
