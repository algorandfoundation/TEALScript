...
export class AbiTest extends bkr.ApplicationClient {
    ...
    override methods: algosdk.ABIMethod[] = [
        ...
        new algosdk.ABIMethod({ name: "returnDynamicArrayInTuple", desc: "", args: [], returns: { type: "(uint64,uint16,uint64[],uint16[])", desc: "" } })
    ];
    ...
    async returnDynamicArrayInTuple(txnParams?: bkr.TransactionOverrides): Promise<bkr.ABIResult<[
        bigint,
        bigint,
        bigint[],
        bigint[]
    ]>> {
        const result = await this.execute(await this.compose.returnDynamicArrayInTuple(txnParams));
        return new bkr.ABIResult<[
            bigint,
            bigint,
            bigint[],
    ...
    compose = {
        ...
        returnDynamicArrayInTuple: async (txnParams?: bkr.TransactionOverrides, atc?: algosdk.AtomicTransactionComposer): Promise<algosdk.AtomicTransactionComposer> => {
            return this.addMethodCall(algosdk.getMethodByName(this.methods, "returnDynamicArrayInTuple"), {}, txnParams, atc);
        }
    };
}
