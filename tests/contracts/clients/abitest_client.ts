...
export class AbiTest extends bkr.ApplicationClient {
    ...
    override methods: algosdk.ABIMethod[] = [
        ...
        new algosdk.ABIMethod({ name: "returnDynamicArrayFromTuple", desc: "", args: [], returns: { type: "uint64[]", desc: "" } })
    ];
